...
public class Logger {
    ...
    public func INFO(items: Any ..., separator: String = " ", terminator: String = "\n",
                     _ file: String = #file, _ line: Int = #line, _ function: String = #function)
    {
        Logger._log(.Info, items, separator: separator, terminator: terminator, file, line, function)
    }
    
    public func ALERT(items: Any ..., separator: String = " ", terminator: String = "\n",
                      _ file: String = #file, _ line: Int = #line, _ function: String = #function)
    {
        Logger._log(.Alert, items, separator: separator, terminator: terminator, file, line, function)
    }
    
    public func DEBUG(items: Any ..., separator: String = " ", terminator: String = "\n",
                      _ file: String = #file, _ line: Int = #line, _ function: String = #function)
    {
        Logger._log(.Debug, items, separator: separator, terminator: terminator, file, line, function)
    }
    
    public func ERROR(items: Any ..., separator: String = " ", terminator: String = "\n",
                      _ file: String = #file, _ line: Int = #line, _ function: String = #function)
    {
        Logger._log(.Error, items, separator: separator, terminator: terminator, file, line, function)
    }
#endif